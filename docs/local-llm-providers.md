...
Use `docs/dgx-spark-remote-access.md` for the DGX access path. Keep the model server bound to loopback on the DGX, then tunnel it to the Hermes host or control host.
