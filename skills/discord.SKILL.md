---
name: discord
description: Use this skill for Discord operations and Hermes Discord thread work: sending, reading, editing, deleting, reacting, searching, pinning, creating threads or polls through the message tool, and triaging Hermes Discord requests. Trigger whenever the user asks to post to Discord, inspect a Discord thread, reply in a channel or DM, check whether Hermes is working from a Discord link, or manage Discord messages. Use the Hermes HIL gate before acting on ambiguous or risky Discord requests.
