---
type: Workflow
title: Discord Thread Triage
description: Workflow for checking whether Hermes is working on a Discord thread and interpreting thread state.
resource: repo://hermes-workspace/knowledge/workflows/discord-thread-triage.md
tags: [hermes, discord, triage]
timestamp: 2026-06-27T00:00:00+09:00
source_path: docs/discord-thread-triage.md
---
...
Only after the user explicitly approves the Approval Summary may Hermes enter the Workspace Lifecycle flow. If the clarified task needs a standalone repo, continue with the New Repository HIL Gate in [Workspace Lifecycle](workspace-lifecycle.md) before creating or cloning anything.
